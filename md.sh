...
#SBATCH --job-name=md
#SBATCH --output=/home/ml/zach/Decoupled-Data-Consistency-with-Diffusion-Purification-for-Image-Restoration/log/md.out
#SBATCH --error=/home/ml/zach/Decoupled-Data-Consistency-with-Diffusion-Purification-for-Image-Restoration/log/md.err
